...
{ id: "adult_tension_could_cut", category: "adult", en: "When the tension could be cut with a knife", sv: "När spänningen går att skära med kniv" },
  ...
  { id: "gross_friend_in_background_of_leak", category: "gross", en: "When you see someone you know in the background of a leak", sv: "När du ser någon du känner i bakgrunden av en läckt video" },
