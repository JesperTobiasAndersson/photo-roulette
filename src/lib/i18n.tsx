...
const translations: Record<Language, TranslationDict> = {
  en: {
    ...
    "room.buy_stop_body": "You are on {score}+ points, so you keep your five cards: no more exchanges this round.",
  ...
  sv: {
    ...
    "room.buy_stop_body": "Du är på {score}+ poäng, så du behåller dina fem kort: inga fler byten den här rundan.",
